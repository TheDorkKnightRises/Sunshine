...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
        ...
        if (viewGroup instanceof RecyclerView) {
            ...
            switch (viewType) {
                case VIEW_TYPE_TODAY: {
                    layoutId = thedorkknightrises.sunshine.app.R.layout.list_item_forecast_today;
                    break;
                }
                case VIEW_TYPE_FUTURE_DAY: {
                    layoutId = thedorkknightrises.sunshine.app.R.layout.list_item_forecast;
                    break;
                }
            }
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.mDescriptionView.setContentDescription(mContext.getString(thedorkknightrises.sunshine.app.R.string.a11y_forecast, description));
        ...
        forecastAdapterViewHolder.mHighTempView.setContentDescription(mContext.getString(thedorkknightrises.sunshine.app.R.string.a11y_high_temp, highString));
        ...
        forecastAdapterViewHolder.mLowTempView.setContentDescription(mContext.getString(thedorkknightrises.sunshine.app.R.string.a11y_low_temp, lowString));
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ForecastAdapterViewHolder(View view) {
            super(view);
            mIconView = (ImageView) view.findViewById(thedorkknightrises.sunshine.app.R.id.list_item_icon);
            mDateView = (TextView) view.findViewById(thedorkknightrises.sunshine.app.R.id.list_item_date_textview);
            mDescriptionView = (TextView) view.findViewById(thedorkknightrises.sunshine.app.R.id.list_item_forecast_textview);
            mHighTempView = (TextView) view.findViewById(thedorkknightrises.sunshine.app.R.id.list_item_high_textview);
            mLowTempView = (TextView) view.findViewById(thedorkknightrises.sunshine.app.R.id.list_item_low_textview);
