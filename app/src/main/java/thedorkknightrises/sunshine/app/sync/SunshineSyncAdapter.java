...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void updateWearable() {
        ...
        putDataMapReq.getDataMap().putInt(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, wearHigh);
        putDataMapReq.getDataMap().putInt(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, wearLow);
        putDataMapReq.getDataMap().putString(WeatherContract.WeatherEntry.COLUMN_SHORT_DESC, wearDesc);
